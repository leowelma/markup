...
![](images/lec-4/FAIR.jpeg)
<!-- https://digiresacademy.kit.com/posts/how-to-fair-make-your-data-findable-accessible-interoperable-and-reusable -->

## TADA

<!-- - Transferable -->
<!-- Transferability refers to the ability for anyone to open the file, view the code, and run the script without conversion or alteration -->
<!-- - Accessible -->
<!-- Accessibility refers to the act of publicly archiving the code in a way that provides access to any external user -->
<!-- - Documented -->
<!-- Documentation refers to providing accurate and detailed metadata files that describe the code files and their usage -->
<!-- - Annotated -->
<!-- Annotation refers to the addition of comments within each script, or embedding code within an RMarkdown or Quarto document alongside descriptive text -->


::: footer
[Ivimey-Cook et al. (2025)](https://doi.org/10.32942/X2D93K)
:::
...
::: footer
e.g. with the `targets` package or `Make` files
:::
...
::: footer
[Navarro (2025)](https://blog.djnavarro.net/posts/2025-05-18_multivariate-normal-sampling-floating-point)
:::

## Reproducible environment or containerized

![](images/lec-4/renv.png)

::: footer
e.g. with the `renv` package or a `Docker` container
:::
